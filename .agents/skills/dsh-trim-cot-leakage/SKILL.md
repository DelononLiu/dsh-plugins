...
- **Merged-PR and issue citations inside Agent Notes and postmortems** — sanctioned evidence per the [prose standard](../dsh-prose-standard/SKILL.md)'s change-story routing.
